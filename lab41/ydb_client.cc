 ...
 * @LastEditors: Seven
 * @LastEditTime: 2021-01-02 18:03:51
 */
...
void ydb_client::transaction_begin()
{
	...
	{
		//printf("ydb_client:begin TRANSIDINV\n");
...
void ydb_client::transaction_commit()
{
	...
	if (ret != ydb_protocol::OK)
	{
		//printf("ydb_client:commit ret:%d\n", ret);
		throw ret;
	}
}
